...
// -- Splash Screen Text
const String tAppName = "Complete your leave";
const String tAppTagLine = "Learn To Code. \nFree For Everyone";


// -- On Boarding Text
const String tOnBoardingTitle1 = "Welcome ";
const String tOnBoardingTitle2 = "Learn from YouTube";
const String tOnBoardingTitle3 = "Get Code & Resources";


// -- Welcome Screen Text
const String tWelcomeTitle = "Welcome To ";
const String tWelcomeSubTitle = "Name of the Application.";
